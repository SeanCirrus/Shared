...
Function Add-UserToJamfGroup {
    ...
    Invoke-WebRequest -Uri 'https://companyname.jamfcloud.com/JSSResource/usergroups/id/numberofgroup' -Method PUT -body $userBody -Headers @{Authorization = "Bearer $JamfBearerToken" }
